  ...
  return modules = [function (module) {
    ...
    function caret(input, begin, end, notranslate, isDelete) {
      ...
      if (Array.isArray(begin) && (end = this.isRTL ? begin[0] : begin[1], begin = this.isRTL ? begin[1] : begin[0]), void 0 !== begin.begin && (end = this.isRTL ? begin.begin : begin.end, begin = this.isRTL ? begin.end : begin.begin), "number" == typeof begin) {
        ...
        }, opts.insertModeVisual && !1 === opts.insertMode && begin === end && (isDelete || end++), input === (input.inputmask.shadowRoot || input.ownerDocument).activeElement) if ("setSelectionRange" in input) input.setSelectionRange(begin, end);else if (window.getSelection) {
    ...
    var _mask = __webpack_require__(18),
        ...
        _definitions = _interopRequireDefault(__webpack_require__(23)),
        _defaults = _interopRequireDefault(__webpack_require__(24)),
    ...
    function handleRemove(input, k, pos, strict, fromIsValid) {
      ...
      if (pos.end >= _positioning.getBuffer.call(this).length && lvp >= pos.end && (pos.end = lvp + 1), k === _keycode["default"].BACKSPACE ? pos.end - pos.begin < 1 && (pos.begin = _positioning.seekPrevious.call(this, pos.begin)) : k === _keycode["default"].DELETE && pos.begin === pos.end && (pos.end = _positioning.isMask.call(this, pos.end, !0, !0) ? pos.end + 1 : _positioning.seekNext.call(this, pos.end) + 1), !1 !== (offset = revalidateMask.call(this, pos))) {
        ...
        !0 !== strict && (maskset.p = k === _keycode["default"].DELETE ? pos.begin + offset : pos.begin, maskset.p = _positioning.determineNewCaretPosition.call(this, {
          begin: maskset.p,
          end: maskset.p
        }, !1).begin);
      }
    ...
    var EventHandlers = {
      ...
      inputFallBackEvent: function inputFallBackEvent(e) {
        ...
        if (buffer !== inputValue) {
          ...
          switch ((input.inputmask.shadowRoot || input.ownerDocument).activeElement !== input && input.focus(), (0, _inputHandling.writeBuffer)(input, _positioning.getBuffer.call(inputmask)), _positioning.caret.call(inputmask, input, caretPos.begin, caretPos.end, !0), changes.action) {
            case "insertText":
            case "insertReplacementText":
      ...
      mouseleaveEvent: function mouseleaveEvent() {
        var inputmask = this.inputmask,
            opts = inputmask.opts,
            input = this;
        inputmask.mouseEnter = !1, opts.clearMaskOnLostFocus && (this.inputmask.shadowRoot || this.ownerDocument).activeElement !== this && (0, _inputHandling.HandleNativePlaceholder)(this, inputmask.originalPlaceholder);
      },
    ...
    Object.defineProperty(exports, "__esModule", {
      value: !0
    }), exports["default"] = void 0, __webpack_require__(15), __webpack_require__(25), __webpack_require__(26), __webpack_require__(27);
    ...
    var _inputmask = _interopRequireDefault(__webpack_require__(10)),
        _masktoken = _interopRequireDefault(__webpack_require__(22));
      ...
      for (regexMask && (opts.optionalmarker[0] = void 0, opts.optionalmarker[1] = void 0); match = regexMask ? regexTokenizer.exec(mask) : tokenizer.exec(mask);) {
        ...
        if (escaped) defaultCase();else switch (m.charAt(0)) {
          ...
          case opts.alternatormarker:
            ...
            if (lastMatch.isAlternator) openenings.push(lastMatch);else if (lastMatch.alternatorGroup ? (alternator = openenings.pop(), lastMatch.alternatorGroup = !1) : alternator = new _masktoken["default"](!1, !1, !1, !0), alternator.matches.push(lastMatch), openenings.push(alternator), lastMatch.openGroup) {
    ...
    function analyseMask(maskString, format, opts) {
      ...
      function setValue(dateObj, value, opts) {
        if (dateObj[targetProp] = value.replace(/[^0-9]/g, "0"), dateObj["raw" + targetProp] = value, void 0 !== dateOperation) {
          ...
          ("day" === targetProp && 29 === parseInt(datavalue) || "month" === targetProp && 2 === parseInt(datavalue)) && (29 !== parseInt(dateObj.day) || 2 !== parseInt(dateObj.month) || "" !== dateObj.year && void 0 !== dateObj.year || dateObj.date.setFullYear(2012, 1, 29)), "day" === targetProp && 0 === parseInt(datavalue) && (datavalue = 1), "month" === targetProp && (datavalue = parseInt(datavalue), 0 < datavalue) && (datavalue -= 1), "year" === targetProp && datavalue.length < 4 && (datavalue = pad(datavalue, 4, !0)), "" === datavalue || isNaN(datavalue) || dateOperation.call(dateObj.date, datavalue);
        }
      }
    ...
    _inputmask["default"].extendAliases({
      datetime: {
        ...
        postValidation: function postValidation(buffer, pos, c, currentResult, opts, maskset, strict, fromCheckval) {
          ...
          return result && dateParts.date.getTime() == dateParts.date.getTime() && (opts.prefillYear && (result = prefillYear(dateParts, result, opts)), result = isValidDate.call(this, dateParts, result, opts), result = isDateInRange(dateParts, result, opts, maskset, fromCheckval)), void 0 !== pos && result && currentResult.pos !== pos ? {
